item modify entity @s weapon.offhand jolted:gun/bullet_count
data modify storage jolted:storage root.temp.bullet_lore set from entity @s Inventory[{Slot:-106b}].tag.display.Lore[0]
...
item modify entity @s weapon.offhand jolted:copy_nbt
